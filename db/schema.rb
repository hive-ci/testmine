...
ActiveRecord::Schema.define(version: 20_170_627_190_941) do
  ...
  add_index 'results', %w[run_id test_definition_id], name: 'index_results_on_run_id_and_test_definition_id', using: :btree
  ...
  create_table 'suites', force: :cascade do |t|
    ...
    t.text     'documentation', limit: 65_535
  ...
  add_index 'suites', %w[project name], name: 'index_suites_on_project_and_name', using: :btree
  ...
  add_index 'test_definitions', %w[name suite_id file parent_id], name: 'lookup', using: :btree
  ...
  add_index 'worlds', %w[project component version], name: 'index_worlds_on_project_and_component_and_version', using: :btree
  add_index 'worlds', %w[project component], name: 'index_worlds_on_project_and_component', using: :btree
